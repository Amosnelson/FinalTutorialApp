 ...
 */
public class workingObjectFragment extends Fragment {

    public workingObjectFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_working_object, container, false);
