...
import com.example.finaltutorialapp.Classes.History;
import com.example.finaltutorialapp.Classes.Recommendations;
...
public class MainDownloadActivity extends AppCompatActivity {
    ...
    private Runnable permissionsAndUISetupThread = () -> {
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(MainDownloadActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 0);
...
//            Toast.makeText(this, "Don't shoot blanks!", Toast.LENGTH_LONG, FancyToast.ERROR, false).show();
...
//    }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(MainDownloadActivity.this,MainActivity.class);
        startActivity(intent);
    }
}
